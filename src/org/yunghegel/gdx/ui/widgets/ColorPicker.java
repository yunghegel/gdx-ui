...
import org.yunghegel.gdx.utils.ui.widgets.TabPane;
...
public class ColorPicker extends Table {
    ...
    private void addColorVector(VisTable table, String name, Supplier<Float> getter, Consumer<Float> setter, Runnable updater, Range range) {
        VisSlider slider = UI.sliderTable(table, name, 0f, range == Range.ANGLE_360 ? 360 : 1f, getter.get(), UI.ControlScale.LIN, v->{
            setter.accept(v);
            updater.run();
            updateColorVectors();
        });
